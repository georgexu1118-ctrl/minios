...
import { Cpu, Satellite, Zap, ArrowLeft, RotateCcw } from "lucide-react";
...
const SUGGESTED = [
  ...
  "Compare Apple vs Microsoft market cap",
    ...
    <div className="relative flex flex-col h-screen overflow-hidden">
      ...
      <header className="relative z-10 glass border-b px-4 py-3 flex items-center justify-between flex-shrink-0"
        ...
        <div className="flex items-center gap-4">
          <div className="hidden sm:flex items-center gap-4 text-[10px] text-violet-400/50">
            <span className="flex items-center gap-1">
              <Satellite size={10} /> gpt-4o-mini
            </span>
            <span className="flex items-center gap-1">
              <Zap size={10} />
      ...
      <footer className="relative z-10 glass border-t px-4 py-4 md:px-8 flex-shrink-0"
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-center text-[9px] text-violet-500/30 mt-2 tracking-widest uppercase">
            AAOS Research · Kernel · Hermes · OpenAI · Live Web
          </p>
        </div>
      </footer>
    </div>
