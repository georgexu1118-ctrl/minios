...
function TutorMascot({ className = "" }: { className?: string }) {
  return (
    <div
      className={className}
      style={{
        maskImage: "radial-gradient(ellipse 80% 75% at 62% 72%, black 30%, transparent 68%)",
        WebkitMaskImage: "radial-gradient(ellipse 80% 75% at 62% 72%, black 30%, transparent 68%)",
      }}
    >
      <Image
        src="/baby-yoda.png"
